...
$(_7ad).datagrid("loadDictionaryData",data);
if(cb){
cb();
}
},function(){
...
$(_8cd).datagrid("loadDictionaryData",[row]);
return;
}
...
$(this).treegrid("loadDictionaryData",_978.options.data);
}
_8f0(this);
});
};
...
if(data.total){
$(this).datalist("loadDictionaryData",data);
}
}
});
};
...
tree.tree("loadDictionaryData",data);
});
},reload:function(jq,url){
return jq.each(function(){
var opts=$.data(this,"combotree").options;

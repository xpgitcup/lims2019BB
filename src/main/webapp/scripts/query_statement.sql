...
INSERT INTO `query_statement` VALUES (217, 1, 'thingTypeId', 'select count(*) from Plan plan where plan.thingTypeId=cast(:thingTypeId as integer)', b'0', b'1', 'count.operation4Plan.通用计划.thingTypeId', NULL);
INSERT INTO `query_statement` VALUES (218, 1, 'thingTypeList', 'select count(*) from Team team where team.thing in :thingTypeList', b'0', b'1', 'count.operation4ProjectPlan.进度归档.myself', NULL);
INSERT INTO `query_statement` VALUES (219, 1, 'thingTypeList', 'from Team team where team.thing in :thingTypeList order by team.thing', b'0', b'1', 'list.operation4ProjectPlan.进度归档.myself', 'listTeam');
INSERT INTO `query_statement` VALUES (220, 1, 'thingTypeList', 'select count(*) from Team team where team.thing in :thingTypeList', b'0', b'1', 'count.operation4ProjectPlan.进度归档.thingTypeList', NULL);
INSERT INTO `query_statement` VALUES (221, 1, 'thingTypeList', 'from Team team where team.thing in :thingTypeList order by team.thing', b'0', b'1', 'list.operation4ProjectPlan.进度归档.thingTypeList', 'listTeam');
INSERT INTO `query_statement` VALUES (224, 2, 'currentTeam', 'from Progress progress where progress.team=:currentTeam order by progress.regDate desc', b'0', b'1', 'list.operation4ProjectPlan.currentTeam.进度列表', 'listProgress');
INSERT INTO `query_statement` VALUES (225, 1, 'currentTeam', 'select count(*) from Progress progress where progress.team=:currentTeam', b'0', b'1', 'count.operation4ProjectPlan.currentTeam.进度列表', NULL);
